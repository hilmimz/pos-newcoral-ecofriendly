...
<div class="container-fluid px-4">
    ...
    @endforeach --}}
    @endforeach
    <h1 class="mt-4">Table Pengiriman Barang Ke {{ Session::get('cabang') }}</h1>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('terimabarang.konfirmasi',$pengiriman->pengiriman_id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <label for="keterangan" class="mt-3">Keterangan (Opsional)</label>
